...
board_games |> 
ggplot() +  
geom_point(aes(x=playing_time, y = average_playtime), color = "blue") + 
labs (title = "Play Time of Board Games VS Average Rating", 
      x = "Average Rating", 
      y = "Play Time")
```
...
board_games%>%
ggplot() + 
geom_point(aes(x=average_rating, y = users_rated), color = "red") + 
...
ggplot() + 
geom_point(aes(x=average_rating, y = max_players), color = "yellow") + 
