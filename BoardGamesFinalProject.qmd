...
for (i in 1:length(Boardgame1$compilation)) {
  if (is.na(Boardgame1$compilation[i])){
    Boardgame1$compilation[i] <- "no"}
  else {
Boardgame1$compilation[i] <- "yes"}
for (i in 1:length(Boardgame1$expansion)) {
  if (is.na(Boardgame1$expansion[i])){
    Boardgame1$expansion[i] <- "no"}
  else {
    Boardgame1$expansion[i] <- "yes" }
